...
- [x] Frontend ve backend uygulaması
...
## Canlı bağlantı hazır olunca birlikte kontrol
...
- [ ] Gerçek biyografi, hizmet, iletişim ve görselleri gir
- [ ] Taslak/örnek içerikleri kaldır
- [ ] KVKK, gizlilik, çerez ve saklama metinlerini onaylat
